...
config_dict = {
    ...
    "redteam": {
        "purpose": "Act as plant operations expert",
        "numTests": 1,
        "plugins": [
            "pii:social"
        ]
...
try:
    ...
    process, config_path, output_path = run_promptfoo_command_in_background(config_dict)
    print(f"Process started with PID: {process.pid}")

    # Monitor process status and print stdout in real-time
    while True:
